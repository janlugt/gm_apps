...
public class sssp implements Tool {
    ...
    public final int run(final String[] args) throws Exception {
        ...
        job.getConfiguration().setVertexClass(ssspVertex.class);
        job.getConfiguration().setMasterComputeClass(ssspVertex.Master.class);
        job.getConfiguration().setWorkerContextClass(ssspVertex.Context.class);
        job.getConfiguration().setVertexInputFormatClass(ssspVertexInputFormat.class);
        GiraphFileInputFormat.addVertexInputPath(job.getInternalJob(), new Path(cmd.getOptionValue('i')));
        if (cmd.hasOption('o')) {
            job.getConfiguration().setVertexOutputFormatClass(ssspVertexOutputFormat.class);
