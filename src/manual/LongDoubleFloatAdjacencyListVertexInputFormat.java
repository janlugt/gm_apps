 ...
 */
public class LongDoubleFloatAdjacencyListVertexInputFormat<M extends Writable>
  ...
  protected class LongDoubleDoubleAdjacencyListVertexReader extends
    ...
    @Override
    public Edge<LongWritable, FloatWritable> decodeEdge(String s1, String s2) {
      return new DefaultEdge<LongWritable, FloatWritable>(
          new LongWritable(Long.valueOf(s1)),
          new FloatWritable(Float.valueOf(s2)));
    }
  }
