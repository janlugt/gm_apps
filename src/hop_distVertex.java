...
public class hop_distVertex
    extends EdgeListVertex< LongWritable, hop_distVertex.VertexData, NullWritable, hop_distVertex.MessageData > {

    // Vertex logger
    private static final Logger LOG = Logger.getLogger(hop_distVertex.class);
